function celebrityGame() {
    var words = ["drake", "trevor noah", "rihanna", ,"scarlett johansson", "brad pitt", "kanye west", "robin williams", "oprah", "meryl streep", "michael jackson", "ellen degeneres", "jamie foxx"];
